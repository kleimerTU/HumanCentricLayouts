...
def get_args():
    ...
    parser.add_argument(u'--continue_train', action=u'store_true', default=False)
    parser.add_argument(u'--load_encoder', type=str, default=u'')
    parser.add_argument(u'--load_decoder', type=str, default=u'')
    parser.add_argument(u'--no_verbose', action=u'store_true', default=False)
    parser.add_argument(u'--manual_seed', type=int, default= -1)
    parser.add_argument(u'--scene_name', type=str, default=u'generated_scenes')
