...
def main(argv):
  ...
  for i in range(n_models):
    ...
    for model_n in model_names:
      ...
      ergo_score = evaluate_scenes(sequences, minvalue_dict, maxvalue_dict, dict_cat2fun, use_log=True,grid_quantization=True, device=sequences.device,
      ...
      if args.num_room_plots > 0:
        ...
        plot_sequences_grid(sequences[:args.num_room_plots,:], dict_int2cat, dict_cat2int, minvalue_dict, maxvalue_dict, res, path_save_plots=path_save_plots)
